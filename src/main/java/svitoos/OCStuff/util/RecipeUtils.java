...
public class RecipeUtils {
  ...
  public static void addShapedRecipe(ItemStack result, Object... recipe) {
    ...
    GameRegistry.findRegistry(IRecipe.class)
        .register(
            new ShapedOreRecipe(null, result, recipe)
                .setRegistryName(result.getItem().getRegistryName().getPath() + recipeCounter));
    recipeCounter++;
  }
  ...
  public static void addShapelessRecipe(ItemStack result, Object... recipe) {
    ...
    GameRegistry.findRegistry(IRecipe.class)
        .register(
            new ShapelessOreRecipe(null, result, recipe)
                .setRegistryName(result.getItem().getRegistryName().getPath() + recipeCounter));
    recipeCounter++;
  }
  ...
  private static void warnCrafting(ItemStack result, Object[] recipe) {
    ...
    OCStuff.warn("Invalid recipe: %s -> %s", Arrays.toString(recipe), result);
  }
}
